<%-- 
    ...
    Created on : 5 may 2025, 20:51:59
    Author     : Lu
--%>
...
<html>
    <head>
        ...
        <title>Editar Producto - ChocoArte</title>
    ...
    <body>
        ...
        <div class="container my-5">
            <div class="p-4 rounded-3 shadow-sm" style="background-color: rgba(0, 0, 0, 0.05)">
                <h4 class="text-center mb-4 custom-text-shadow" style="color:#8B4513">Editar Producto</h4>
                ...
                <form action="ControladorProducto" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <c:if test="${not empty imagen}">
                            <p class="mt-2">Imagen actual: <strong>${imagen}</strong></p>
                        </c:if>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <input type="submit" class="btn btn-gold" value="Editar Producto">
                    </div>
                </form>
            </div>
        </div>
