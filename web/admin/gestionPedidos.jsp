        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 px-5 p-4">
                ...
                <div class="d-flex justify-content-between mb-3">
                    <a href="ControladorPedido?crear=true" class="btn btn-gold">Crear Pedido Nuevo</a>
                </div>
                ...
                <table class="table table-striped mt-3">
                    ...
                    <tbody>
                        <c:forEach var="pedido" items="${pedidos}">
                            <tr>
                                <td>${pedido.id}</td>
                                <td><fmt:formatDate value="${pedido.fecha}" pattern="yyyy-MM-dd"/></td>
                                <td>${pedido.estado}</td>
                                <td>$ ${pedido.precio}</td>
                                ...
                                <td>
                                    ...
                                    <a href="ControladorPedido?id=${pedido.id}&editar=true" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Editar</a>
                                    <a href="ControladorPedido?id=${pedido.id}&eliminar=true" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Eliminar</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
