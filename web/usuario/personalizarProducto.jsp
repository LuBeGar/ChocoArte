...
<html>
        ...
        <div class="container my-5 flex-grow-1">
            <div class="row pt-5 rounded-3 shadow-sm" style="background-color: rgba(0, 0, 0, 0.05)">
                ...
                <div class="col-md-6">
                    ...
                    <form id="formPersonalizacion" action="ControladorProductoPersonalizado" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select shadow" id="alergenos" name="alergenos" onchange="gestionarOtrosAlergenos()" required>
                                ...
                                <option value="otros" ${alergenos == 'otros' ? 'selected' : ''}>Otros</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-4" id="otrosAlergenosDiv" style="display:${alergenos == 'otros' ? 'block' : 'none'};">
                            ...
                            <input type="text" class="form-control shadow" id="otrosAlergenos" 
                                   name="otrosAlergenos" value="${otrosAlergenos}" 
                                   placeholder="Ej: Frutos secos, soja..." 
                                   ${alergenos == 'otros' ? '' : 'disabled'} 
                                   ${alergenos == 'otros' ? 'required' : ''}>
                            <div class="invalid-feedback">
                        ...
                        <!-- Imagen -->
                        <div class="mb-3">
                            <label for="imagen" class="form-label text-dark">Puedes añadir una imagen de referencia</label>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-center mt-4">
                            <a href="ControladorPrincipal" class="btn btn-secondary btn-lg m-2 btn-back">
    ...
    <script src="js/personalizarProducto.js"></script>
</body>
</html>
